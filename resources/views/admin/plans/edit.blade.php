...
<div class="max-w-4xl mx-auto space-y-8">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-xl font-extrabold text-slate-900 tracking-tight">Paketi Düzenle: {{ $plan->name }}</h1>
            <p class="text-slate-500 mt-1 font-medium text-sm">Paket detaylarını ve özelliklerini güncelleyin.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.plans.update', $plan) }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" value="{{ old('name', $plan->name) }}" class="w-full bg-slate-50 border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-3 h-[46px]">
                         <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="is_popular" value="1" class="sr-only peer" {{ old('is_popular', $plan->is_popular) ? 'checked' : '' }}>
                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <input type="text" name="description" value="{{ old('description', $plan->description) }}" class="w-full bg-slate-50 border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="number" step="0.01" name="price_monthly" value="{{ old('price_monthly', $plan->price_monthly) }}" class="w-full bg-slate-50 border-slate-200 rounded-xl px-4 py-3 pl-10 text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="number" step="0.01" name="price_yearly" value="{{ old('price_yearly', $plan->price_yearly) }}" class="w-full bg-slate-50 border-slate-200 rounded-xl px-4 py-3 pl-10 text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
                        <span class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-bold">₺</span>
                    </div>
        ...
        <!-- Limits -->
        @php $currentLimits = $plan->limits ?? []; @endphp
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="number" name="limits[user_count]" value="{{ old('limits.user_count', $currentLimits['user_count'] ?? 1) }}" class="w-full bg-slate-50 border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
                </div>
                <div class="space-y-2">
                    <label class="text-xs font-bold text-slate-500 uppercase tracking-wider">Aylık Teklif</label>
                    <input type="number" name="limits[proposal_monthly]" value="{{ old('limits.proposal_monthly', $currentLimits['proposal_monthly'] ?? 10) }}" class="w-full bg-slate-50 border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
                </div>
                <div class="space-y-2">
                    <label class="text-xs font-bold text-slate-500 uppercase tracking-wider">Müşteri Limiti</label>
                    <input type="number" name="limits[customer_count]" value="{{ old('limits.customer_count', $currentLimits['customer_count'] ?? 50) }}" class="w-full bg-slate-50 border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
                </div>
                <div class="space-y-2">
                    <label class="text-xs font-bold text-slate-500 uppercase tracking-wider">Ürün Limiti</label>
                    <input type="number" name="limits[product_count]" value="{{ old('limits.product_count', $currentLimits['product_count'] ?? 20) }}" class="w-full bg-slate-50 border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
                </div>
            </div>
        </div>
